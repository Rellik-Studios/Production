...
namespace Himanshu
{
    ...
    public class EnemyController : MonoBehaviour, IEnemy
    {
        ...
        public bool PatrolToChaseTransition()
        {
            ...
            var colliders = Physics.OverlapSphere(transform.position, m_hearingRadius * ((m_player.crouching || m_player.GetComponent<CharacterController>().velocity.magnitude < 0.1f) ? 0.5f : 3f));
