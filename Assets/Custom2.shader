Shader "DistortionShaderPack/Custom2"
{
	Properties
	{
		_CameraOpaqueTexture("_CameraOpaqueTexture", 2D) = "black" { }
	...
	Category
	{
		Tags { "Queue" = "Transparent" "RenderType" = "Opaque" "RenderPipeline" = "LightweightPipeline" "IgnoreProjector" = "True" }
		ZWrite Off
		SubShader
		{
			Pass
